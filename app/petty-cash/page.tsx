  ...
  return (
    <div className="max-w-screen-xl mx-auto px-6 py-8">
      ...
      {records.length > 0 && (
        ...
        >
          <span className="text-sm" style={{ color: '#92600d' }}>סה"כ</span>
            ...
            <tbody>
              {records.map((r, i) => (
                ...
                >
                  ...
                  <td className="px-4 py-3.5" style={{ color: '#4a5e52' }}>{r.purpose}</td>
...
function EmptyState({ onAdd }: { onAdd: () => void }) {
  return (
    <div className="bg-white rounded-xl p-16 text-center" style={{ border: '1px solid #e5ddd4' }}>
      ...
      <p className="font-semibold mb-1" style={{ color: '#1a2620' }}>אין רשומות עדיין</p>
